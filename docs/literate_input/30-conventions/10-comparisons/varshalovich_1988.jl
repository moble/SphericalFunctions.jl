...
by previous authors.  Varshalovich et al. define their Euler angles (Sec. 1.4.1, scheme B,
page 22) in the same way we do, except that they specify that this describes the rotation
