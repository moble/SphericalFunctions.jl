...
[^1]: That is, in addition to what we would recognize as basis vectors ``ι₁, ι₂, ι₃``, he
...
of pairs of ``ι₁, ι₂, ι₃`` that happen to be exactly the *negative* of modern definitions —
or at least the ones we use here:
