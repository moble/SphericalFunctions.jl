...
the few available tools for dealing with three-dimensional quantities.  But, as such, this
book was a broadly influential introduction to quaternions for many years.  (The tragic
quaternion-vector wars would play out over the next few decades; even though Clifford had
already unified the two notions, his early death would leave a void in the field filled by
decades of carnage and confusion.)
