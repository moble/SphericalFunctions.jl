...
function _step_1(Hwedge):
    """If n=0 set H_{0}^{0,0}=1."""
    Hwedge[1] = 1
end


function _step_2(g, h, n_max, mp_max, Hwedge, Hextra, Hv, expiβ):
...
function _step_3(a, b, n_max, mp_max, Hwedge, Hextra, expiβ):
...
function _step_4(d, n_max, mp_max, Hwedge, Hv):
...
function _step_5(d, n_max, mp_max, Hwedge, Hv):
